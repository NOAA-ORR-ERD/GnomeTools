...
A script that builds a cube form the CFS data
...
It  builds TAP cubes out of a set of  trajectory files.
...
CubesList = [ (os.path.join(setup.RootDir,'CFS-runs'), (os.path.join(setup.CubesPath, 'Cube01') ) ),
             ]


#for ( (Season,junk), CubeRootName ) in zip(setup.Seasons, setup.CubesRootNames):
#    # build the directory structure
#    SeasonTrajDir = os.path.join(setup.RootDir, setup.TrajectoriesPath, Season)
...
if setup.ReceptorType == "Grid":
    ...
    for TrajFilesDir, CubeName in CubesList:
        ...
        if CubeExists and ( os.path.getsize(CubeName) > 0 ): 
            ...
            print "Cubename:",  CubeName, os.path.split(CubeName)
