...
# get lat/lon from hecwfs operational model
hecwfs = 'http://tds.glos.us/thredds/dodsC/FVCOM/HECWFS-Latest-Forecast.nc'
nc = Dataset(hecwfs)
stclair.data['lon'] = nc.variables['lon']
stclair.data['lat'] = nc.variables['lat']
